...
$claims[] = $claim->getAllDocuments();



$i = 0;
foreach($claims[0] as $row){
    $i++;
...
<tr> 
     ...
     <td><a href ="rejectclaim.php?token=<?php echo $row['ClaimID'] ?>" class ="btn btn-danger">X</a></td>
     <td><a href ="acceptclaim.php?token=<?php echo $row['ClaimID'] ?>" class ="btn btn-success">✓</a></td>
